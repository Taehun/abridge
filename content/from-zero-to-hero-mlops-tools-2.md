...
> 
> - 머신러닝 실험 환경: [JupyterHub](https://jupyterhub.readthedocs.io/en/stable/), [Kubeflow Notebooks](https://www.kubeflow.org/docs/components/notebooks/), [TensorBoard](https://www.tensorflow.org/tensorboard?hl=ko)
> - 메타데이터 저장소: [MLflow Tracking](https://mlflow.org/docs/latest/tracking.html)
> - 소스코드 리포지토리: [GitHub](https://github.com/), [GitLab](https://gitlab.com/)
...
> 
> - 머신러닝 파이프라인: [AIrflow](https://airflow.apache.org/), [Kubeflow Pipeline](https://www.kubeflow.org/docs/components/pipelines/v2/)
