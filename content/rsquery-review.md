...
새로운 프로그래밍 언어를 익히는 가장 빠른 방법은 새로 배운 언어로 뭔가 만들어보는 것이라고 생각합니다. Rust 프로그래밍 언어 공부를 목적으로 [Rust 프로그래밍 언어 스터디](/rust-)를 진행하였고, Rust 언어로 토이 프로젝트도 했습니다. 저는 RSQuery라는 프로젝트를 기획해서 만들었습니다.
...
![notion image](https://img-src.io/taehun/rsquery-review/1.png?w=800)
...
<!-- TODO: 이미지 추가 - 파일명: hqdefault.jpg, 원본: https://i.ytimg.com/vi/KNdcRr1JU2k/hqdefault.jpg -->
